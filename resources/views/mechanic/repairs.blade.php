            ...
            <form method="POST" id="editForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="comment" class="form-textarea" id="commentField"
                            placeholder="Szerelői megjegyzés..."></textarea>
                    </div>
                </div>
    ...
    <div class="page-wrap">
        ...
        <div class="page-header">
            ...
            <button class="btn-primary" onclick="openModal('addModal')"
                style="font-size:0.8rem;padding:0.6rem 1.25rem;">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="vehicle_id" class="form-select" required>
                                ...
                                @foreach($vehicles as $v)
                                    <option value="{{ $v->id }}">{{ $v->brand }} {{ $v->model }} · {{ $v->license_plate }}
                                        ({{ $v->username }})</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="comment" class="form-textarea"
                                placeholder="Javítás részletei..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn-edit"
                                    onclick="openEditModal({{ $r->id }}, '{{ $r->brand }} {{ $r->model }}', {{ $r->status_repairs_id }}, '{{ addslashes($comment === '—' ? '' : $comment) }}')">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
