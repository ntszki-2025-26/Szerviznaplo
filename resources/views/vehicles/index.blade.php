...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .vehicle-card:hover { border-color: rgba(232,184,75,0.4); }
    ...
    .vehicle-detail { font-size: 0.82rem; }
    .vehicle-detail .label { color: var(--muted); display: block; margin-bottom: 0.15rem; font-size: 0.72rem; letter-spacing: 0.1em; text-transform: uppercase; }
    .vehicle-detail .value { color: var(--text); font-weight: 500; }
